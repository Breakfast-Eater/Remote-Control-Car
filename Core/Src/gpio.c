...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOB, AIN2_Pin|BIN1_Pin|BIN2_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : GPIO_EXTI0_Pin GPIO_EXTI1_Pin */
  GPIO_InitStruct.Pin = GPIO_EXTI0_Pin|GPIO_EXTI1_Pin;
