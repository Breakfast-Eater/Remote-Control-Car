...
/* Private defines -----------------------------------------------------------*/
#define TIM2_PWMB_Pin GPIO_PIN_0
#define TIM2_PWMB_GPIO_Port GPIOA
...
#define GPIO_EXTI0_Pin GPIO_PIN_0
#define GPIO_EXTI0_GPIO_Port GPIOB
#define GPIO_EXTI0_EXTI_IRQn EXTI0_IRQn
#define GPIO_EXTI1_Pin GPIO_PIN_1
#define GPIO_EXTI1_GPIO_Port GPIOB
#define GPIO_EXTI1_EXTI_IRQn EXTI1_IRQn
...
#define TIM1_PWMA_Pin GPIO_PIN_8
#define TIM1_PWMA_GPIO_Port GPIOA
